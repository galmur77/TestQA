...
"""INFO Product #1 (нформация по продукту №1)"""
...
assert value_price_product_1 == value_cart_price_product_1 #сравниваем цену товара в каталоге и корзине
...
assert value_product_1 == value_finish_product_1 #сравниваем название товара в каталоге и заказе
...
assert value_price_product_1 == value_finish_price_product_1 #сравниваем цену товара в каталоге и заказе
...
"""Select User INFO (Вводим информацию по пользователю"""
time.sleep(3)
driver.quit()